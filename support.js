...
(function(){
  ...
  function installMobileHeader(){
    ...
    var lang=document.createElement('button');lang.type='button';lang.className='br-fixed-lang';lang.innerHTML=langBtn?langBtn.innerHTML:'🇬🇧 EN';lang.addEventListener('click',function(){var b=document.querySelector('header .header-actions button');if(b)b.click();});
