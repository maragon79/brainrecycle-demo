/* BrainRecycle bootstrap: restore stable Home behaviour + isolated Dashboard mobile menu emphasis. */
(function(){
  ...
  /* Exact Home header behaviour from the last user-validated stable point (798c33b). */
  ...
  /* Dashboard-only enhancement. It never runs on Home, so it cannot interfere with Jotform. */
  ...
  s.onload=function(){
    var run=function(){
      ...
      else if(isDashboard()) emphasizeDashboardMenu();
    };
